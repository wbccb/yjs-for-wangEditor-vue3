...
const CURSOR_CHANGE_EVENT_LISTENERS: WeakMap<Editor, Set<RemoteCursorChangeEventListener>> = new WeakMap();
...
export const CursorEditor = {
  ...
  sendCursorData<TCursorData extends Record<string, unknown>>(editor: CursorEditor<TCursorData>, data: TCursorData) {
